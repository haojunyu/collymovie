...
func main() {
	...
	detailCollector.OnHTML(`div[id=rendered-content]`, func(e *colly.HTMLElement) {
		...
		title := e.ChildText("h1.banner-title")
		if title == "" {
		...
		course := Course{
			...
			Description: e.ChildText(".description div.rc-TogglableContent div.content"),
			Creator:     e.DOM.Find("div.rc-InstructorListSection .instructor-name").Text(),
			//e.ChildText("div.rc-InstructorListSection .instructor-name"),
		}
		log.Printf("Course result1: %+v\n", course)
